...
let WishlistsController = class WishlistsController {
    ...
    async updateWishlist({ user }, id, updateWishlistDto) {
        return await this.wishlistsService.updateWishlist(id, user.id, updateWishlistDto);
    }
...
], WishlistsController.prototype, "getAllWishlists", null);
__decorate([
    (0, common_1.Post)(),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, update_wishlist_dto_1.UpdateWishlistDto]),
    __metadata("design:returntype", Promise)
